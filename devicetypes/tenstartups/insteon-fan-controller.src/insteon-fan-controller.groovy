...
metadata {
	definition (name: "Insteon Fan Controller", author: "marclennox", namespace: "TenStartups") {
  		capability "Actuator"
	...
	tiles(scale: 2) {
		...
		multiAttributeTile(name: "switch", type: "lighting", width: 6, height: 4, canChangeIcon: true) {
			...
			tileAttribute ("device.fanMode", key: "PRIMARY_CONTROL") {
                ...
                attributeState "turningOn", action:"fanHigh", label:"TURNING_ON", icon:"st.Lighting.light24", backgroundColor:"#2179b8", nextState: "turningOn"			//light blue bckgrd
        ...
        standardTile("fanLight", "device.switch", width: 2, height: 2, decoration: "flat") {
            state "off", label:'${name}', action: "switch.on", icon:"https://raw.githubusercontent.com/dcoffing/SmartThingsPublic/master/devicetypes/dcoffing/hampton-bay-universal-ceiling-fan-light-controller.src/Light175xfinal.png", backgroundColor: "#ffffff", nextState:"turningOn"
            state "on", label:'${name}', action: "switch.off", icon:"https://raw.githubusercontent.com/dcoffing/SmartThingsPublic/master/devicetypes/dcoffing/hampton-bay-universal-ceiling-fan-light-controller.src/Light175xfinal.png", backgroundColor: "#79b821", nextState:"turningOff"
        ...
        standardTile("fanLow", "device.fanMode", inactiveLabel: false, width: 2, height: 2) {
            ...
            state "turningLow", label:"ADJUST", action: "fanLow", icon:"https://raw.githubusercontent.com/dcoffing/SmartThingsPublic/master/devicetypes/dcoffing/hampton-bay-universal-ceiling-fan-light-controller.src/Fan175xfinal.png", backgroundColor: "#2179b8"
        }
        ...
        standardTile("fanMedium", "device.fanMode", inactiveLabel: false, width: 2, height: 2) {
            ...
            state "turningMedium", label:"ADJUST", action: "fanMedium", icon:"https://raw.githubusercontent.com/dcoffing/SmartThingsPublic/master/devicetypes/dcoffing/hampton-bay-universal-ceiling-fan-light-controller.src/Fan175xfinal.png", backgroundColor: "#2179b8"
        }
        ...
        standardTile("fanHigh", "device.fanMode", inactiveLabel: false, width: 2, height: 2) {
            ...
            state "turningHigh", label:"ADJUST", action: "fanHigh", icon:"https://raw.githubusercontent.com/dcoffing/SmartThingsPublic/master/devicetypes/dcoffing/hampton-bay-universal-ceiling-fan-light-controller.src/Fan175xfinal.png", backgroundColor: "#2179b8"
        } 
        ...
        details(["switch", "fanLight", "fanHigh", "fanMedium", "fanLow", "fanOff", "refresh"])
    }
...
def fanMedium() {
	sendCommand("fan_medium")
}

def fanHigh() {
	sendCommand("fan_high")
}
...
def processStatusUpdate(data) {
    ...
    if (data.speed != null) {
	    log.debug "[${insteonId()}] Fan speed is ${data.speed.toUpperCase()}"
	    sendEvent(name: "fanMode", value: "fan${data.speed.capitalize()}")
    }
}
