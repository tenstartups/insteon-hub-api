...
module.exports.routes = {
  ...
  ***************************************************************************/
  ...
  'post /api/dimmable_light/:id/status': 'DimmableLightController.status',
  ...
  'post /api/fan/:id/status': 'FanController.status',
  ...
  'post /api/light/:id/status': 'LightController.status',
  ...
  'post /api/outlet/:id/status': 'OutletController.status',
  ...
  'post /api/scene/:id/status': 'SceneController.status',
